<template>
    <div class="contact-info pl-90 pl-md-0 pl-sm-0 pl-xs-0">
        <form id="app" class="become-teacher-form" @submit.prevent="checkForm" method="post" v-if="!success && !loading">
            ...
            <h5 class="max-mb-30">Preencha o formulário abaixo para participar de todos os eventos sobre o SGL.</h5>
            <div class="row">
                ...
                <div class="col-12 max-mb-30">
                    <textarea class="textareaEvemt" placeholder="Tem alguma sugestão para o novo evento? Conta para gente!" name="message" id="message"  v-model="message"></textarea>
